...
def help_info() -> str:
    ...
    text += '/unban никнейм пользователя - возвращает пользователя из забанненых\n'
    ...
    text += '/addChannel ссылка на чат - добавляет группу/канал, в список участников лотереи\n'
    text += '/deleteChannel ссылка на чат - удаляет группу/канал, из списока участников лотереи\n'
    text += '/getChannels - выводит список групп/каналов, учавствующих в лотерее\n\n'
